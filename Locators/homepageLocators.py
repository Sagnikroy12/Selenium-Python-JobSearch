...
class HomepageLocators:
    ...
    DISMISS_BUTTON = (
        ...
        "or contains(@class, 'modal__dismiss')]",
    )
    ...
    DATE_POSTED_DONE_BUTTON = (
        By.XPATH,
        "//button[@data-tracking-control-name='public_jobs_f_TPR' and @type='submit']",
    )
    ...
    JOB_CARD = (By.CSS_SELECTOR, "[data-job-id]")

    GUEST_JOB_API_URL = "https://www.linkedin.com/jobs-guest/jobs/api/jobPosting/{job_id}"
    VOYAGER_JOB_API_URL = "https://www.linkedin.com/voyager/api/jobs/jobPostings/{job_id}"
    JOB_DESCRIPTION_MARKUP_SELECTOR = ".show-more-less-html__markup"
